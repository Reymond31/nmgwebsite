<div id="products">
	<div class="container-fluid">
      				...
      				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  						<div class="carousel-inner">
    						<div class="item active">
     								<img class="img-responsive" src="<?php echo base_url("assets/img/heffy-1.jpg")?>" alt="heffy-1">
     ...
     <div class="modal fade bs-example-modal-lg-txtsupport" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div id="carousel-example-generic-txtsuppport" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="item active">
                    <img class="img-responsive" src="<?php echo base_url("assets/img/txtsupport-1.jpg")?>" alt="txtsupport-1">
                    <div class="carousel-caption">
                      One Image
                    </div>
                </div>
                <div class="item">
                    <img class="img-responsive" src="<?php echo base_url("assets/img/txtsupport-2.jpg")?>" alt="txtsupport-2">
                    <div class="carousel-caption">
                      Another Image
                    </div>
                </div>
                <div class="item">
                    <img class="img-responsive" src="<?php echo base_url("assets/img/txtsupport-3.jpg")?>" alt="txtsupport-3">
                    <div class="carousel-caption">
                      Another Image
                    </div>
                </div>
              </div>
              <a class="left carousel-control" href="#carousel-example-generic-txtsuppport" role="button" data-slide="prev">
                <i class="icon-chevron-left"></i>
              </a>
				...
				<div class="col-lg-6 col-xs-6 no-padding">
    				<div id="f1_container">
						<div id="f1_card" class="shadow">
 							 ...
 							 <div class="back face center">
    							<p class="z">Customer engagement with brands are ever-increasing with Facebook. Conducting any scale of customer support using Facebook Messenger involves manpower and training. NMG created a powerful and simple solution to use Chatbot which guides customers over chat. The range of functionality extend from quick walk through to complex E-Commerce processes, all managed within an integrated platform.</p>
  							</div>
						</div>
					</div>
				</div>
    			...
    			<div class="col-lg-6 col-xs-6 no-padding">
    				<div id="f1_container">
						<div id="f1_card" class="shadow">
 							 ...
 							 <div class="back face center">
    							<p class="z">Marketing promotions have grown in the past decade, often exceeding the capabilities of existing point-of-sales devices. POS Partner works with any standard Windows-based POS, and automatically allows marketing solutions without any changes to the existing POS. </p>
  							</div>
						</div>
					</div>
    		</div>
